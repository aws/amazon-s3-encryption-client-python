...
from .pipelines import PutEncryptedObjectPipeline, GetEncryptedObjectPipeline
from .materials.keyring import AbstractKeyring
from .materials.crypto_materials_manager import AbstractCryptoMaterialsManager, DefaultCryptoMaterialsManager
...
class S3EncryptionClient():
    ...
    def put_object(self, Bucket, Key, Data, EncryptionContext=None, **kwargs):
        ...
        encrypted_data, encryption_metadata = pipeline.encrypt(data_bytes, encryption_context=EncryptionContext)
    ...
    def get_object(self, EncryptionContext=None, **kwargs):
        ...
        decrypted_data = pipeline.decrypt(response, EncryptionContext) #encrypted_data, encryption_metadata)
