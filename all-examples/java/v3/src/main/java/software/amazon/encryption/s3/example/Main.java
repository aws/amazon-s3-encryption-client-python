...
/**
 * Example demonstrating the use of Amazon S3 Encryption Client v3 for Java.
 * 
 * This example shows how to:
 * 1. Initialize the S3 Encryption Client with KMS keyring
 * 2. Encrypt and upload an object to S3
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== S3 Encryption Client v3 Example (Java) ===");
        ...
        String testData = "Hello, World! This is a test message for S3 encryption client v3 in Java.";
        System.out.println("Original data: " + testData);
        System.out.println("Data length: " + testData.length() + " bytes");
        System.out.println();

        try {
            System.out.println("--- Initialize S3 Encryption Client v3 ---");
