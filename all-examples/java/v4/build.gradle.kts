...
dependencies {
    // S3 Encryption Client Java v4 from local staging repository
    implementation("software.amazon.encryption.s3:amazon-s3-encryption-client-java:3.4.0-IMPROVED")
