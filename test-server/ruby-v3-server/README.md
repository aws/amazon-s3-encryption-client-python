...
that provides an invariant interface around the S3 Encryption Client v3.
It's designed to work alongside other implementations of test servers for cross-language compatibility testing.

## Overview

The server provides a REST API that wraps the AWS S3 Encryption Client v3,
...
The server runs on port **8092** by default.
