<?php
namespace Local\Aws\S3\Crypto;

use Local\Aws\Crypto\DecryptionTraitV2;
use Aws\Exception\CryptoException;
use Aws\HashingStream;
use Aws\MetricsBuilder;
use Aws\PhpHash;
use Local\Aws\Crypto\AbstractCryptoClientV2;
use Local\Aws\Crypto\EncryptionTraitV2;
use Local\Aws\Crypto\MetadataEnvelope;
use Local\Aws\Crypto\MaterialsProvider;
use Local\Aws\Crypto\Cipher\CipherBuilderTrait;
use Aws\S3\S3Client;
 ...
 * </code>
 */
class S3EncryptionClientV3 extends AbstractCryptoClientV2
{
    ...
    public function getObjectAsync(array $args)
    {
        ...
        $promise = $this->client->getObjectAsync($args)
            ->then(
                function ($result) use ($provider, $instructionFileSuffix, $strategy, $args) {
                    if ($strategy === null) {
